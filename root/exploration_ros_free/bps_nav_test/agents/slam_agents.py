...
from bps_nav_test.config.default import get_config as cfg_baseline
from bps_nav_test.slambased.mappers import DirectDepthMapper
from bps_nav_test.slambased.monodepth import MonoDepthEstimator
from bps_nav_test.slambased.path_planners import DifferentiableStarPlanner
from bps_nav_test.slambased.reprojection import (
...
from bps_nav_test.slambased.utils import generate_2dgrid
...
class ORBSLAM2MonodepthAgent(ORBSLAM2Agent):
    def __init__(
        ...
        monocheckpoint="bps_nav/slambased/data/mp3d_resnet50.pth",
    ):
        self.num_actions = config.NUM_ACTIONS
        self.dist_threshold_to_stop = config.DIST_TO_STOP
        self.slam_vocab_path = config.SLAM_VOCAB_PATH
