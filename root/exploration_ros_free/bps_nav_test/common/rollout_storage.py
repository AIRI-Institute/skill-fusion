...
class RolloutStorage:
    ...
    def compute_returns(self, next_value, use_gae, gamma, tau):
        if use_gae:
            ...
            #print(self.storage_buffers["value_preds"][self.step].shape, next_value.shape)
            #print(self.storage_buffers["observations"]["task_id"][self.step].flatten())
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        for mb_inds in torch.randperm(num_processes).chunk(num_mini_batch):
            ...
            for ind in mb_inds:
                ...
                mb["recurrent_hidden_states"][-1] = mb["recurrent_hidden_states"][-1][0:1]
...
class DoubleBufferedRolloutStorage:
    ...
    def recurrent_generator(self, advantages, num_mini_batch, timing, device=None):
        ...
        #print('NUMBATCH: ',num_processes,num_mini_batch)    
        #print('NUM_PROC: ',torch.randperm(num_processes).chunk(num_mini_batch))    
        ...
        for mb_inds in torch.randperm(num_processes).chunk(num_mini_batch):
            with timing.add_time("Generate-Mini-Batch"):
                ...
                #print('MB REC SHAPE: ',mb["recurrent_hidden_states"].shape)
                #print('MB OBS SHAPE: ',mb["observations"]["depth"].shape)
