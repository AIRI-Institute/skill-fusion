...
def get_args(arguments):
    ...
    parser.add_argument('-efsw', '--env_frame_semantic_width', type=int, default=256,
                        help='Frame width (default:84)')
    parser.add_argument('-efsh', '--env_frame_semantic_height', type=int, default=256,
                        help='Frame height (default:84)')
    ...
    parser.add_argument('--vision_range', type=int, default=40)
