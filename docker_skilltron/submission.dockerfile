...
ADD ../root/skilltron/habitat_map /root/exploration_ros_free/habitat_map
ADD ../root/skilltron/main_evalai.py /root/exploration_ros_free/main_evalai.py
ADD ../root/skilltron/EXPLORE_policy.py /root/exploration_ros_free/EXPLORE_policy.py
ADD ../root/skilltron/GR_policy.py /root/exploration_ros_free/GR_policy.py
ADD ../root/skilltron/rnn_state_encoder.py /root/exploration_ros_free/rnn_state_encoder.py
ADD ../root/skilltron/policy.py /root/exploration_ros_free/policy.py
ADD ../root/skilltron/config.py /root/exploration_ros_free/config.py
ADD ../root/skilltron/config.yaml /root/exploration_ros_free/config.yaml
ADD ../root/skilltron/weights /root/exploration_ros_free/weights
ADD ../root/skilltron/exploration /root/exploration_ros_free/exploration
ADD ../root/skilltron/planners /root/exploration_ros_free/planners
