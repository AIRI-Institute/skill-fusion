...
ADD ../root/skillfusion/habitat_map /root/exploration_ros_free/habitat_map
ADD ../root/skillfusion/main_evalai.py /root/exploration_ros_free/main_evalai.py
ADD ../root/skillfusion/EXPLORE_policy.py /root/exploration_ros_free/EXPLORE_policy.py
ADD ../root/skillfusion/GR_policy.py /root/exploration_ros_free/GR_policy.py
ADD ../root/skillfusion/rnn_state_encoder.py /root/exploration_ros_free/rnn_state_encoder.py
ADD ../root/skillfusion/policy.py /root/exploration_ros_free/policy.py
ADD ../root/skillfusion/config.py /root/exploration_ros_free/config.py
ADD ../root/skillfusion/config.yaml /root/exploration_ros_free/config.yaml
ADD ../root/skillfusion/weights /root/exploration_ros_free/weights
ADD ../root/skillfusion/exploration /root/exploration_ros_free/exploration
ADD ../root/skillfusion/planners /root/exploration_ros_free/planners
ADD ../root/skillfusion/semexp /root/exploration_ros_free/semexp
ADD ../root/skillfusion/bps_nav_test /root/exploration_ros_free/bps_nav_test
